...
public class CodeGenerator {
    ...
    private static final String superEntityClass = null;
    ...
    public static void main(String[] args) {
        ...
        dsc.setUsername(CodeGenerator.user);
        dsc.setPassword(CodeGenerator.pwd);
